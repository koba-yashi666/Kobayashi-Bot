...
const DB_FILE = path.join(
  ...
  "\x61\x64\x6d\x69\x6e\x2d\x6c\x6f\x67\x73\x2e\x6a\x73\x6f\x6e"
);
...
function normalizeDb(raw) {
  ...
  if (
    raw.groups &&
    typeof raw.groups === "\x6f\x62\x6a\x65\x63\x74" &&
...
function readDb() {
  ...
  try {
    const raw = fs.readFileSync(DB_FILE, "\x75\x74\x66\x38");
    return normalizeDb(JSON.parse(raw));
  } catch (error) {
    console.error(
      "\x5b\x41\x64\x6d\x69\x6e\x4c\x6f\x67\x73\x5d\x20\x45\x72\x72\x6f\x20\x61\x6f\x20\x6c\x65\x72\x20\x62\x61\x6e\x63\x6f\x3a",
      error?.message || error
    );
...
function writeDb(db) {
  ...
  try {
    ...
    console.error(
      "\x5b\x41\x64\x6d\x69\x6e\x4c\x6f\x67\x73\x5d\x20\x45\x72\x72\x6f\x20\x61\x6f\x20\x73\x61\x6c\x76\x61\x72\x20\x62\x61\x6e\x63\x6f\x3a",
      error?.message || error
    );
...
function normalizeEntry(entry = {}) {
  return {
    ...
    type: String(
      entry.type || "\x61\x64\x6d\x69\x6e"
    ).toLowerCase(),
    ...
    detail: String(
      entry.detail ||
        entry.message ||
        "\x41\xe7\xe3\x6f\x20\x61\x64\x6d\x69\x6e\x69\x73\x74\x72\x61\x74\x69\x76\x61"
    ),
    ...
    meta:
      entry.meta &&
      typeof entry.meta === "\x6f\x62\x6a\x65\x63\x74"
        ? entry.meta
        : undefined,
  };
}
...
export function setAdminLogEnabled(groupJid, enabled = true) {
  ...
  const db = readDb();
  if (!db.configs || typeof db.configs !== "\x6f\x62\x6a\x65\x63\x74") db.configs = {};
  if (!db.configs[groupJid] || typeof db.configs[groupJid] !== "\x6f\x62\x6a\x65\x63\x74") {
    db.configs[groupJid] = {};
  }
...
function maybeCleanup() {
  ...
  try {
    ...
    console.error(
      "\x5b\x41\x64\x6d\x69\x6e\x4c\x6f\x67\x73\x5d\x20\x45\x72\x72\x6f\x20\x6e\x61\x20\x6c\x69\x6d\x70\x65\x7a\x61\x20\x61\x75\x74\x6f\x6d\xe1\x74\x69\x63\x61\x3a",
      error?.message || error
    );
  }
}
...
export function getAdminLogs(
  ...
  if (typeof filters === "\x6e\x75\x6d\x62\x65\x72") filters = { limit: filters };
  if (!filters || typeof filters !== "\x6f\x62\x6a\x65\x63\x74") filters = {};
  ...
  if (type) {
    logs = logs.filter(
      (entry) => {
        ...
        if (type === "\x61\x6e\x74\x69\x6c\x69\x6e\x6b") {
          return (
            value.includes("\x6c\x69\x6e\x6b") ||
            value.includes(
        ...
        if (type === "\x61\x64\x76") {
          return (
            value.includes("\x61\x64\x76") ||
            value.includes("\x77\x61\x72\x6e")
          );
        }
