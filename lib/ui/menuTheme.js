...
const HELP = {
  ...
  personalidade:"mede de forma divertida a personalidade do membro.", linda:"mede de forma divertida o nível de beleza da pessoa.", lindo:"mede de forma divertida o nível de beleza da pessoa.", gay:"gera um medidor divertido de orgulho/energia.", hetero:"gera um medidor divertido para a brincadeira.", lesbica:"gera um medidor divertido para a brincadeira.", gado:"mede a gadice do membro com um resultado divertido.", feio:"mede a feiura de brincadeira do membro.", corno:"gera o medidor de chifres da brincadeira.", bebado:"gera um medidor divertido de alegria de boteco.", gostoso:"gera um medidor divertido de gostosura.", gostosa:"gera um medidor divertido de gostosura.", golpista:"mede de brincadeira a energia suspeita do membro.", otaku:"mede o poder otaku do membro.", pobre:"gera um medidor financeiro de brincadeira.", rico:"gera um medidor financeiro de brincadeira.", beijo:"envia uma interação de beijo para o membro marcado ou respondido.", carinho:"envia uma interação de carinho.", tapa:"envia uma interação de tapa de brincadeira.", chute:"envia uma interação de chute de brincadeira.", morder:"envia uma interação de mordida de brincadeira.", comer:"chama o membro marcado para comer em uma interação divertida.", socar:"envia uma interação de soco de brincadeira.", lamber:"envia uma interação de lambida de brincadeira.", forca:"inicia ou continua uma partida de forca.", anagrama:"inicia ou responde uma rodada de anagrama.", quiz:"inicia ou responde uma pergunta do quiz.", enigma:"inicia ou responde um enigma.", wordle:"inicia ou continua o jogo de palavras.",
  ...
  mododragonrpg:"ativa/desativa somente o Dragon RPG v2 no grupo. Quando desligado, seus comandos ficam silenciosos.", modorpg:"ativa/desativa somente o RPG clássico no grupo.",
