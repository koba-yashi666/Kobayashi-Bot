...
✰ۣۜۜ͜͡ *KOBAYASHI BOT • v3.0.9*
✰✰✰✰✰`;
export const buildOwnerMenu = (p="/") => commandBox("👑", "𝑪𝑨̂𝑴𝑨𝑹𝑨 𝑫𝑨 𝑲𝑶𝑩𝑨𝒀𝑨𝑺𝑯𝑰", p, [
  "numero_dono","numero_bot","status_bot","prefixo","add_prefixo","nome_gp","foto_gp","foto_menu","antipv","reiniciar","update","statusatt","listanegrag","rmlistanegrag","ban_msg","sentinel","sentinelbridge","aluguel_global","registrar_aluguel","renovar_aluguel","rm_aluguel","lista_aluguel","aluguel_permanente","zerarrpg","zerarrpgg"
,"msg",
  "grupos",
  "grupo",
  "clientes",
