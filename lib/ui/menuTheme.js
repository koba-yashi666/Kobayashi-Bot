...
export const buildAdminMenu = (p="/") => commandBox("🛡️", "𝑺𝑨𝑵𝑻𝑼𝑨́𝑹𝑰𝑶 𝑨𝑫𝑴", p, [
  "paineladm","protecao","statusgrupo","logs","rankadm","resetrankadm","ban","kobaban","adv","rmadv","listadv","listanegra","promover","rebaixar","hidetag","totag","mutar","desmutar","antilink","antitelegram","antispam","antitrava","antimencao","antitextao","antiflood","antidel","antiedit","bemvindo","setbv","setbye","fotobv","fotosaiu","soadm","listabranca","revogarlink","banghost","opengp","closegp",
  "cita"
]);
export const buildStickerMenu = (p="/") => commandBox("🎴", "𝑨𝑻𝑬𝑳𝑰𝑬̂ 𝑫𝑬 𝑬𝑺𝑪𝑨𝑴𝑨𝑺", p, [
  "s","fig","figurinhas","pacote","figurinha","rename","roubar","toimg","togif","autosticker","setcmd","rgfigu","delcmd","listcmdsticker","fontesfig","fontefig","addfontefig","delfontefig"
]);
...
✰ۣۜۜ͜͡ *KOBAYASHI BOT • v5.3.16*
✰✰✰✰✰`;
export const buildOwnerMenu = (p="/") => commandBox("👑", "𝑪𝑨̂𝑴𝑨𝑹𝑨 𝑫𝑨 𝑲𝑶𝑩𝑨𝒀𝑨𝑺𝑯𝑰", p, [
  "numero_dono","numero_bot","status_bot","statuscore","limpartemp","prefixo","add_prefixo","nome_gp","foto_gp","foto_menu","antipv","reiniciar","licenca","ativarlicenca","licencacriar","licencas","licencaver","licencabloquear","licencareativar","licencadesvincular","verificarupdate","update","statusatt","listanegrag","rmlistanegrag","ban_msg","listaban_msg","rmban_msg","sentinel","sentinelbridge","aluguel_global","registrar_aluguel","renovar_aluguel","add_dias","rm_aluguel","lista_aluguel","aluguel_permanente","zerarrpg","zerarrpgg"
,"msg",
  "grupos",
  "grupo",
  "clientes",
...
const HELP = {
  multiprefixo:"[Dono principal] adiciona, remove e lista vários prefixos ativos ao mesmo tempo.",
  mamada:"envia uma ação de zoeira usando @marcação ou resposta à mensagem.",
  bang:"[Dono principal] remove o membro de todos os grupos onde a Kobayashi é administradora. Aceita @, número ou resposta.",
  gozar:"envia a ação de zoeira usando @marcação ou resposta à mensagem.",
  lid:"mostra o LID do membro marcado, respondido ou do próprio usuário.",
  julgar:"faz um julgamento aleatório de zoeira sobre o membro marcado ou respondido.",
  comer:"envia o GIF da ação /comer marcando ou respondendo a alguém.",
  ...
  paineladm:"abre o Admin Center.", protecao:"abre o painel de proteção ou aplica perfis baixa, media, alta e off para configurar vários sistemas de moderação de uma vez.", statusgrupo:"mostra o estado das proteções e sistemas do grupo.", logs:"consulta registros administrativos e de proteção.", rankadm:"mostra o ranking de atividade dos administradores do grupo.", resetrankadm:"zera o Rank ADM do grupo após confirmação.", listanegra:"gerencia a lista negra do grupo e remove automaticamente membros bloqueados.", ban:"remove do grupo o membro marcado ou respondido.", adv:"adiciona uma advertência a um membro.", rmadv:"remove uma advertência de um membro.", listadv:"lista as advertências registradas.", promover:"promove um membro a administrador.", rebaixar:"remove o cargo de administrador.", hidetag:"marca os membros de forma oculta.", totag:"marca os membros do grupo.", mutar:"aplica mute a um membro conforme o sistema de moderação.", desmutar:"remove o mute aplicado.", antilink:"ativa ou desativa a proteção contra links.", antitelegram:"ativa ou desativa o bloqueio de links do Telegram.", antispam:"ativa, desativa ou mostra o AntiSpam Pro.", antitrava:"configura a proteção contra mensagens de trava.", antimencao:"configura a proteção contra excesso de menções.", antitextao:"configura a proteção contra textos grandes demais.", antiflood:"configura a proteção contra flood.", antidel:"ativa ou desativa o anti-apagar mensagens.", antiedit:"ativa ou desativa o anti-edição.", bemvindo:"ativa ou desativa as boas-vindas.", setbv:"define a mensagem de boas-vindas.", setbye:"define a despedida.", fotobv:"define a foto do bem-vindo do grupo.", fotosaiu:"define a foto enviada quando alguém sai do grupo.", soadm:"limita o bot aos administradores.", listabranca:"protege membros de qualquer remoção executada pela Kobayashi e dos filtros automáticos.", revogarlink:"revoga o link atual do grupo.", banghost:"remove membros fantasma/inativos conforme os critérios do comando.", opengp:"abre o grupo para mensagens.", closegp:"fecha o grupo para mensagens dos membros.",
  s:"cria uma figurinha a partir da mídia enviada ou respondida.", fig:"cria uma figurinha a partir da mídia enviada ou respondida.", figurinhas:"envia figurinhas aleatórias do catálogo configurado.", pacote:"captura, registra e envia pacotes de figurinhas. Use /pacote fig on, /pacote fig off, /pacote add Nome, /pacote Nome ou /pacote lista.", figurinha:"envia uma figurinha por vez de um pacote registrado, avançando para a próxima a cada uso.", rename:"renomeia os metadados de uma figurinha.", roubar:"recria uma figurinha com os dados configurados de pacote/autor.", toimg:"converte uma figurinha estática em imagem.", togif:"converte mídia compatível para GIF/figurinha animada.", autosticker:"ativa ou desativa a criação automática de figurinhas.", setcmd:"associa um comando a uma figurinha respondida.", rgfigu:"registra um comando real em uma figurinha respondida, como /rgfigu ban ou /rgfigu menu.", delcmd:"remove o comando associado a uma figurinha.", listcmdsticker:"lista figurinhas com comandos associados.", fontesfig:"lista as fontes de figurinhas.", fontefig:"seleciona ou consulta a fonte de figurinhas.", addfontefig:"adiciona uma fonte ao sistema de figurinhas.", delfontefig:"remove uma fonte do sistema de figurinhas.",
  ...
  zerarrpg:"zera o progresso Dragon RPG de todos os membros do grupo atual. Exclusivo do dono principal e exige confirmação.", zerarrpgg:"zera globalmente todo o Dragon RPG de todos os grupos, incluindo o progresso do próprio dono. Exclusivo do dono principal e exige confirmação.",
  mododragonrpg:"ativa/desativa somente o Dragon RPG v2 no grupo. Quando desligado, seus comandos ficam silenciosos.",
  kobatrigger:"ativa/desativa o Koba Trigger Universal. Reconhece 564 comandos/aliases do bot via Koba <comando> [argumentos]. Frases sem comando real são ignoradas.",
  sentinel:"configura a segunda conta Sentinela contra links invisíveis.", sentinelbridge:"configura a ponte do Kobayashi Sentinel.", listanegrag:"gerencia números na lista negra global.", ban_msg:"registra textos proibidos globalmente; ao detectar, a Kobayashi apaga a mensagem, remove o autor do grupo, adiciona à Lista Negra Global e tenta removê-lo dos demais grupos.", listaban_msg:"lista todos os textos cadastrados no BAN MSG Global e mostra se o sistema está ativo.", rmban_msg:"remove um texto do BAN MSG Global pelo número mostrado em /listaban_msg ou pelo próprio texto.", rmlistanegrag:"remove um número da lista negra global.", licenca:"mostra o estado da licença oficial, plano e acesso às atualizações.", ativarlicenca:"ativa uma licença oficial desta instalação usando uma chave.", licencacriar:"cria uma licença permanente para um comprador.", licencas:"lista as licenças cadastradas no servidor.", licencaver:"mostra detalhes e instalações vinculadas de uma licença.", licencabloquear:"bloqueia uma licença no servidor.", licencareativar:"reativa uma licença bloqueada.", licencadesvincular:"remove o vínculo de uma instalação específica.", verificarupdate:"verifica a versão oficial disponível sem instalar.", update:"valida a licença, cria backup, preserva dados locais e atualiza a Kobayashi pelo canal oficial configurado.", statusatt:"verifica a sincronização da versão local.", planos:"mostra os planos de aluguel.", aluguel:"consulta ou gerencia o aluguel conforme os argumentos.", registrar_aluguel:"registra um grupo no sistema de aluguel.", aluguel_parceria:"registra aluguel com regra de parceria.", renovar_aluguel:"adiciona tempo ao aluguel.", add_dias:"adiciona dias ao vencimento atual do aluguel.", rm_aluguel:"remove um aluguel.", ver_aluguel:"consulta o aluguel do grupo.", lista_aluguel:"lista os aluguéis registrados.", aluguel_permanente:"gerencia um aluguel permanente.",
  prefixo:"mostra ou configura o prefixo principal.", add_prefixo:"adiciona um prefixo aceito pelo bot.", nome_gp:"altera o nome do grupo.", foto_gp:"altera a foto do grupo.", foto_menu:"altera a imagem dos menus quando configurada.", antipv:"configura o Anti-PV em 3 modos: aviso, bloquear ou aluguel; use /antipv aviso, /antipv bloquear, /antipv aluguel ou /antipv off.", reiniciar:"reinicia o processo do bot quando o ambiente permite.", numero_dono:"configura ou consulta o número do dono.", numero_bot:"configura ou consulta o número do bot.", status_bot:"mostra ou configura o status operacional do bot.", statuscore:"mostra uptime, RAM, heap, limpeza, alertas e erros capturados pelo Core V5.", limpartemp:"remove arquivos temporários antigos das pastas seguras da Kobayashi."
};

const ALIASES = {
  rpg:"dragonrpg",menurpg:"dragonrpg",perfilrpg:"rpgperfil",inventariorpg:"rpginventario",classesrpg:"rpgclasses",dragonhelp:"rpgajuda",comandosrpg:"rpgcomandos",geral:"menugeral",menustk:"menusticker",menunivel:"menulevel",menudragon:"menusocial",menushop:"menuloja",menuowner:"menudono",versao:"version",v:"version",atualizar:"update",
  b:"ban",banc:"ban",advs:"listadv",listaadv:"listadv",rm_adv:"rmadv",stk:"s",st:"s",sticker:"s",stickers:"s",toimage:"toimg",autostk:"autosticker",steal:"roubar",take:"roubar",rgcmd:"setcmd",stickercmds:"listcmdsticker",lyrics:"letra",linkgrupo:"linkgp",infogrupo:"grupoinfo",adminlogs:"logs",admincenter:"paineladm",centraladm:"paineladm",statusgp:"statusgrupo",bridge:"sentinelbridge",blacklistg:"listanegrag",rmblacklistg:"rmlistanegrag",whitelist:"listabranca",antifarmdiario:"antifarm",coins:"carteira",saldo:"carteira",pay:"pagar",topcoins:"rankcoins",achievements:"conquistas",inv:"inventario",buy:"comprar",equipartitulo:"equipar",untitle:"desequipartitulo",opencaixa:"abrircaixa",coinflip:"moeda",abraço:"abraco",shipo:"ship",owner:"dono",creator:"criador",adms:"admins",mute:"mutar",desmute:"desmutar",unmute:"desmutar",onlyadm:"soadm",soadmin:"soadm",plans:"planos",rg_aluguel:"registrar_aluguel",renovar_alugel:"renovar_aluguel",adddias:"add_dias",remover_aluguel:"rm_aluguel",ver_alugel:"ver_aluguel",lista_alugel:"lista_aluguel",alugel_permanente:"aluguel_permanente"
};
