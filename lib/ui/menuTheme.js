...
const HELP = {
  ...
  kobatrigger:"ativa/desativa o Koba Trigger no grupo. Ex.: Koba menu, Koba tocar <música>. Frases sem intenção conhecida são ignoradas.",
