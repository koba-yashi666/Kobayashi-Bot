...
✰ۣۜۜ͜͡ *KOBAYASHI BOT • v3.0.2*
✰✰✰✰✰`;
export const buildOwnerMenu = (p="/") => commandBox("👑", "𝑪𝑨̂𝑴𝑨𝑹𝑨 𝑫𝑨 𝑲𝑶𝑩𝑨𝒀𝑨𝑺𝑯𝑰", p, [
  "numero_dono","numero_bot","status_bot","prefixo","add_prefixo","nome_gp","foto_gp","foto_menu","antipv","reiniciar","update","statusatt","listanegrag","rmlistanegrag","sentinel","sentinelbridge","aluguel_global","registrar_aluguel","renovar_aluguel","rm_aluguel","lista_aluguel","aluguel_permanente","zerarrpg","zerarrpgg"
,"msg"
]);

const HELP = {
  menu:"abre o menu principal da Kobayashi.", dragonrpg:"abre o menu principal do Dragon RPG.", rpgcriar:"cria seu personagem no Dragon RPG.", rpgperfil:"mostra sua ficha, atributos, classe e progresso no Dragon RPG.", rpginventario:"mostra os itens e equipamentos do personagem do Dragon RPG.", rpgclasses:"lista as classes humanas e as linhagens dracônicas.", classeinfo:"explica a função, bônus e requisitos de uma classe do Dragon RPG.", rpgclasse:"escolhe sua classe humana inicial no Dragon RPG.", despertardragao:"inicia o Despertar Dracônico ao atingir Level social 20 ou mais.", rpgfaccao:"escolhe a facção dracônica durante o Despertar.", rpgdragao:"escolhe a linhagem dracônica compatível com sua facção.", rpgajuda:"abre o manual explicativo do Dragon RPG.", rpgcomandos:"lista os comandos disponíveis do Dragon RPG.", menugeral:"abre a Central Essencial com os comandos gerais.", menuadm:"abre a Central de Administração do grupo.", menusticker:"abre o Atelier de Figurinhas.", menulevel:"abre a Trilha de Níveis e rankings de XP.", menusocial:"abre o Reino Dragon Social, com moedas e conquistas.", menuloja:"abre o Empório Dragon.", menubn:"abre o Salão de Brincadeiras.", menudono:"abre a Câmara do Dono com comandos exclusivos.", helpcmd:"explica para que serve um comando selecionado.", cita:"marca todos os participantes do grupo e pode enviar um texto junto; exclusivo para ADM/dono.", menuv3:"abre a Central V3 com integrações locais inspiradas nas bases Kobayashi.", calc:"faz cálculos locais sem API.", antipalavra:"configura bloqueio local de palavras no grupo.", addautoresposta:"cria uma resposta automática local no grupo.", listargrupos:"lista os grupos da Kobayashi; exclusivo do dono.", msg:"envia um aviso para todos os grupos da Kobayashi marcando todos os participantes; exclusivo do dono principal.",
