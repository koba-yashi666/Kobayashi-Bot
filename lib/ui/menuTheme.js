...
export function buildMainMenu({ sender, botName="Kobayashi Bot", ownerName="Kobayashi-666", prefix="/", version="1.0.13" }={}) {
...
export const buildFunMenu = (p="/") => commandBox("🎮", "𝑺𝑨𝑳𝑨̃𝑶 𝑫𝑨 𝑲𝑨𝑵𝑵𝑨", p, [
