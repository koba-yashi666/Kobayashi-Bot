...
export const buildAdminMenu = (p="/") => commandBox("🛡️", "𝑺𝑨𝑵𝑻𝑼𝑨́𝑹𝑰𝑶 𝑨𝑫𝑴", p, [
  "paineladm","protecao","statusgrupo","logs","rankadm","resetrankadm","ban","kobaban","adv","rmadv","listadv","listanegra","promover","rebaixar","hidetag","totag","mutar","desmutar","antilink","antitelegram","antifake","banfake","antispam","antitrava","antimencao","antitextao","antiflood","antidel","antiedit","bemvindo","setbv","setbye","fotobv","fotosaiu","soadm","listabranca","revogarlink","banghost","opengp","closegp",
  "cita"
]);
